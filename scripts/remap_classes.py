# -*- coding: utf-8 -*-
"""Generates class files for multiple keyboard layouts based on the class file english (US) keyboard layout.

Usage:
    # Generate all target keyboard layouts
    python2 remap_classes.py classes_US.txt 

    # Generate a specific target keyboard layout
    python2 remap_classes.py classes_US.txt DE
"""
...
if len(sys.argv) < 2:
    print "No classes file name given."
    sys.exit()
...
for lang in languageList:
    ...
    outfilename = "classes %s.txt" % lang
